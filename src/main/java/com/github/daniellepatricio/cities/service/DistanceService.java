package com.github.daniellepatricio.cities.service;

import com.github.daniellepatricio.cities.entities.City;
import com.github.daniellepatricio.cities.repositories.CityRepository;
import com.github.daniellepatricio.utils.StringLocationUtils;
...
public class DistanceService {
   ...
   * @return
   */
  public Double distanceUsingMath(final Long city1, final Long city2, final com.github.daniellepatricio.cities.service.EarthRadius unit) {
   ...
   * @return
   */
  public Double distanceUsingPoints(final Long city1, final Long city2, final com.github.daniellepatricio.cities.service.EarthRadius unit) {
  ...
  private double doCalculation(final double lat1, final double lon1, final double lat2,
                               final double lng2, final com.github.daniellepatricio.cities.service.EarthRadius earthRadius) {
